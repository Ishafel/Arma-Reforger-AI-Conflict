...
Исторический отчёт. После пользовательского прогона 2026-09-07 исключения
композиции отменены: они пропускали физические препятствия самого depot.
Актуальная реализация: [безопасная позиция и локальный выезд](LOGISTICS_SPAWN_EGRESS.md).
