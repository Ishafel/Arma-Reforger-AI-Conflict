...
Актуальное уточнение от 2026-09-07: [штатные исключения композиции](LOGISTICS_SPAWN_PARITY.md).
Ниже сохранён исторический отчёт 2026-09-06; правило «props depot не исключаются» заменено.
