...
Актуальное поведение от 2026-09-07: [безопасная позиция и локальный выезд](LOGISTICS_SPAWN_EGRESS.md).
Ниже сохранён исторический отчёт 2026-09-06. Его запрет проверять выезд больше
не действует; props depot снова участвуют в физических проверках.
...
Текущий gate проверяет короткий локальный выезд, а не прямой путь до дороги.
