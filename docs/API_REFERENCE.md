...
8. Автоматического финального PASS нет. Приёмка требует полного остановленного server/client log, ручной матрицы, Transport T10, Armed A2, отдельных retry/approach/order/cap/cleanup fault-срезов и 30-минутного прогона.
