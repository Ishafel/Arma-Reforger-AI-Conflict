...
Assert-OrderedAfter $planner 'protected bool TryResolveFalseCompletionEndpoint(' 'GetClosestPositionOnNavmesh(' 'GetReachablePoint(navmeshOrigin' 'FALSE_COMPLETION_NAVMESH_ORIGIN_SNAP'
Assert-Contains $planner 'FALSE_COMPLETION_ROUTE_MAX_DETOUR_METERS' 'FALSE_COMPLETION_BOUNDED_DETOUR'
Assert-OrderedAfter $planner 'protected bool TryResolveFalseCompletionEndpoint(' 'FALSE_COMPLETION_ROUTE_MAX_DETOUR_METERS' 'remainingMeters >= bestRemainingMeters' 'FALSE_COMPLETION_BOUNDED_DETOUR'
Assert-OrderedAfter $planner 'protected bool TryResolveFalseCompletionEndpoint(' 'objectiveDistanceMeters <= FALSE_COMPLETION_ROUTE_MIN_PROGRESS_METERS' 'endpoint = objectivePosition' 'FALSE_COMPLETION_FINAL_OBJECTIVE_LEG'
Assert-Contains $match 'MOB_EGRESS_HIDDEN_TARGET_STANDOFF_METERS = 15.0' 'MOB_EGRESS_TARGET_ADJACENT_CLEARANCE'
