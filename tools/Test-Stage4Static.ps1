...
Assert-Contains 'STAGE4_VEHICLE_ADMISSION_CAP' $vehicleCoordinator 'GetCappedActiveOrReservedCount\(\)\s*\+[\s\S]*GetPreLeaseNonTerminalCount[\s\S]*VEHICLE_CAP_UNAVAILABLE_PRE_ADMISSION' 'Infantry vehicle admission remains capped; logistics leases are exempt'
