...
// OBB конкретного prefab. Физические объекты своего depot также препятствия:
// editable-принадлежность не отключает столкновения созданной машины.
class AICF_LogisticsVehicleFootprint
{
	...
	bool IsClear(BaseWorld world, vector transform[4], out TraceOBB body)
	{
		...
		float penetration = world.TracePosition(body, null);
